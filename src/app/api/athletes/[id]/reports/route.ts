...
const MOCK_ATHLETE_REPORTS: Record<string, any[]> = {
  'athlete-1': [{
    ...
    file_url: null,
    insights: ['Força máxima: +12% vs Fevereiro', 'VO2 Max estimado: 52ml/kg/min (+3%)', 'Taxa de recuperação melhorou 15%', 'Consistency score: 94%'],
    recommendations: ['Manter volume atual de treino', 'Adicionar trabalho de mobilidade', 'Considerar taper para competição']
  }, {
    id: 'report-2',
    ...
    file_url: null,
    insights: ['HRV médio: 68ms (excelente)', 'Qualidade de sono: 8.2/10', 'Zero lesões ativas', 'Stress autonómico controlado'],
    recommendations: ['Continuar monitorização diária de HRV', 'Manter rotina de sono', 'Revisão em 3 meses']
  }, {
    id: 'report-3',
    ...
    file_url: null,
    insights: ['Objetivos atingidos: 8/8 (100%)', 'PRs estabelecidos: 12', 'Attendance rate: 96%', 'Melhoria geral: +18%'],
    recommendations: ['Estabelecer novos objetivos para Q1', 'Considerar aumento de intensidade', 'Preparação para competição regional']
  }, {
    id: 'report-4',
    ...
    file_url: null,
    insights: ['Posição inicial: Excelente', '1ª Puxada: Boa velocidade', '2ª Puxada: Timing a melhorar', 'Receção: Estável e confiante'],
    recommendations: ['Drills de timing para 2ª puxada', 'Trabalho de força explosiva', 'Vídeo análise semanal']
  }],
  'athlete-2': [{
    id: 'report-5',
    ...
    file_url: null,
    insights: ['Nível atual: Intermediário', 'Pontos fortes: Endurance cardiovascular', 'A melhorar: Força máxima, mobilidade de anca', 'Histórico: 2 anos de treino'],
    recommendations: ['Programa de força 3x/semana', 'Trabalho de mobilidade diário', 'Reavaliação em 6 semanas']
  }, {
    id: 'report-6',
    ...
    file_url: null,
    insights: ['Squat: +15kg', 'Deadlift: +20kg', 'Consistency: 94%', 'Técnica melhorada: 35%'],
    recommendations: ['Aumentar complexidade dos treinos', 'Introduzir barbell cycling', 'Continuar desenvolvimento de força']
  }]
};
...
export async function GET(request: NextRequest, {
  ...
  try {
    ...
    const {
      data: reports,
      error
    } = await supabase.from('athlete_reports').select(`
        id,
        title,
        type,
        status,
